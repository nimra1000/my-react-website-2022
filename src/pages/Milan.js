                ...
                <div className="row">
                    <div className="media">
                        ...
                        <figure className="figure">
                            <img src={First} className="figure-img img-fluid rounded" alt="..."/>
